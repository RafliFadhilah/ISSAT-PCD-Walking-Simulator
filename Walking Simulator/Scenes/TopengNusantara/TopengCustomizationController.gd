...
func _ready():
	...
	# Store buttons in arrays for easier management
	base_buttons = [base1_button, base2_button, base3_button]
	mata_buttons = [mata1_button, mata2_button, mata3_button]
	mulut_buttons = [mulut1_button, mulut2_button, mulut3_button]
...
func update_base_selection():
	...
	if selected_base > 0 and selected_base <= base_buttons.size():
		base_buttons[selected_base - 1].modulate = Color.GREEN
...
func update_mata_selection():
	...
	if selected_mata > 0 and selected_mata <= mata_buttons.size():
		mata_buttons[selected_mata - 1].modulate = Color.GREEN
...
func update_mulut_selection():
	...
	if selected_mulut > 0 and selected_mulut <= mulut_buttons.size():
		mulut_buttons[selected_mulut - 1].modulate = Color.GREEN
